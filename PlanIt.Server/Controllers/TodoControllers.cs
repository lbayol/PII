...
namespace PlanIt.Controllers
{
    ...
    public class TodoController : ControllerBase
    {
        ...
        // Méthode pour générer un planning de todos à partir d'une date de démarrage
        ...
        {
            // Supprimer les Todos existants de l'utilisateur
            ...
            // Récupérer l'utilisateur et ses données associées depuis la base de données
            ...
            // Initialiser une liste de Todos vides
            ...
            // Pour chaque tâche, générer les Todos en fonction de la disponibilité de l'utilisateur et de la deadline de la tâche
            foreach (var tache in tachesTriees)
            {
                ...
                // Calculer la durée restante de la tâche
        ...
        // Méthode afin de marquer comme réalisé une todo (jamais utilisée par la suite)
        ...
        //Méthode pour supprimer toutes les todos d'un utilisateur
        ...
        //Méthode pour regénérer les todos à partir de l'id d'une todo. Cela permet de pouvoir adapter le planning si l'uilisateur renseigne qu'il n'a pas réalisé une tâche
        ...
        // Méthode afin de supprimer une todo d'un utilisateur
